sap.ui.define([
	...
	return Controller.extend("sap.req.compra.controller.Cockpit", {
				...
				Itens: [
					{
						...
						knttp:"P", 
						matnr:"10010067", 
						maktx:"FIO CP 150 RB ENGRAXADA 10,70MM",
						meins:"KG",
						pspnr:"E036.POCRCD15.BLC.09.01",
						qtdReq:"5,000",
						precoReq:"418671",
						vlrTotal:"0,00",
						dataRemessa:"04/07/2022",
						infnr:"5300040188"
					},
					{
						bnfpo:"00020", 
						knttp:"P", 
						matnr:"10010067", 
						maktx:"FIO CP 160 RB ENGRAXADA 12,70MM",
						meins:"KG",
						pspnr:"E036.POCRCD15.BLC.09.01",
						qtdReq:"5,000",
						precoReq:"418671",
					...
					},
					{
						...
						knttp:"P", 
						matnr:"10010067", 
						maktx:"FIO CP 190 RB ENGRAXADA 15,70MM",
						meins:"KG",
						pspnr:"E036.POCRCD15.BLC.09.01",
						qtdReq:"5,000",
						precoReq:"418671",
		...
		handleValueHelpExtwg: function(oEvent) {
			var sInputValue = oEvent.getSource().getValue();

			this.inputId = oEvent.getSource().getId();
			// create value help dialog
			if (!this._valueHelpDialogExtwg) {
				this._valueHelpDialogExtwg = sap.ui.xmlfragment(
					"sap.req.compra.view.fragments.valuehelps.Extwg",
					this
				);
				this.getView().addDependent(this._valueHelpDialogExtwg);
			}

			this._valueHelpDialogExtwg.open();
		},

		handleValueHelpSearchGrupoMercadorias: function(oEvent) {
		...
		handleCloseGrupoMercadorias: function(oEvent) {
		...
		handleValueHelpFornecedores: function(oEvent) {
			...
			if (!this._valueHelpDialogFornecedores) {
				this._valueHelpDialogFornecedores = sap.ui.xmlfragment(
					"sap.req.compra.view.fragments.valuehelps.Lifnr",
					this
				);
		...
		handleValueHelpCentro: function(oEvent) {
			this._eventSource = oEvent.getSource().getId();

			this.inputId = oEvent.getSource().getId();
			// create value help dialog
			if (!this._valueHelpDialogCentro) {
				this._valueHelpDialogCentro = sap.ui.xmlfragment(
					"sap.req.compra.view.fragments.valuehelps.Werks",
					this
				);
				this.getView().addDependent(this._valueHelpDialogCentro);
			}

			this._valueHelpDialogCentro.open();
		},

		handleValueHelpSearchCentro: function(oEvent) {
		...
		handleValueHelpCloseCentro: function(oEvent) {
		// 	var aContexts = oEvent.getParameter("selectedContexts");
		// 	if (aContexts && aContexts.length) {
		// 		var oContext = aContexts[0];
		...
		handleValueHelpOrgCompra: function(oEvent) {
			this._eventSource = oEvent.getSource().getId();

			this.inputId = oEvent.getSource().getId();
			// create value help dialog
			if (!this._valueHelpDialogOrgCompra) {
				this._valueHelpDialogOrgCompra = sap.ui.xmlfragment(
					"sap.req.compra.view.fragments.valuehelps.Ekorg",
					this
				);
				this.getView().addDependent(this._valueHelpDialogOrgCompra);
			}

			this._valueHelpDialogOrgCompra.open();
		},

		handleValueHelpSearchOrgCompra: function(oEvent) { 

		},

		handleValueHelpCloseOrgCompra: function(oEvent) { 
		...
		handleValueHelpMaterial: function(oEvent) {
			...
			if (!this._valueHelpDialogMaterial) {
				this._valueHelpDialogMaterial = sap.ui.xmlfragment(
					"sap.req.compra.view.fragments.valuehelps.Matnr",
					this
				);
		...
		handleValueHelpSearchMaterial: function(oEvent) { 

		},

		handleValueHelpCloseMaterial: function(oEvent) { 

		},

		handleValueHelpElementoPep: function(oEvent) {
			this._eventSource = oEvent.getSource().getId();
			...
			if (!this._valueHelpDialogMaterial) {
				this._valueHelpDialogMaterial = sap.ui.xmlfragment(
					"sap.req.compra.view.fragments.valuehelps.Pspnr",
					this
				);
				this.getView().addDependent(this._valueHelpDialogMaterial);
			}
		...
		handleValueHelpSearchElementoPep: function(oEvent) { 
